...
ให้ใส่ทั้งหมดไว้ใน "tasks" แบบนี้ แต่ถ้าเป็นการสนทนาปกติ ไม่เกี่ยวข้องกับงาน หรือตารางเรียนให้ "tasks" เป็น null:
{
  "status": "normal",
  "replyText": String // ให้ตอบกลับคำขอของผู้ใช้งาน สามารถเป็นข้อความยาวได้ถ้าจำเป็น,
  "tasks": [...] || null,
}

ถ้ามีการพูดถึงตารางเรียน หรืองาน แต่ไม่พบข้อมูลที่ผู้ใช้ต้องการ หรือค่าไม่สามารถเป็น null ได้ ให้คืนค่า
{
  "status": "error",
