...
class _TodoPageState extends State<TodoPage> {
  ...
  Future<void> _loadOption() async {
    _sortOption = await loadSortOption();
    setState(() {});
  }

  void _changeSortOption() async {
    setState(() {
      _sortOption =
          SortOption.values[(_sortOption.index + 1) % SortOption.values.length];
    });
    await saveSortOption(_sortOption);
  }
  ...
  void initState() {
    ...
    _sortOption = SortOption.createdTime;
    _loadOption();
  }
          ...
          return StreamBuilder(
            ...
            builder: (context, entrySnapshot) {
              ...
              List<Todo> incompleteTodos =
                  entrySnapshot.data!.where((todo) => !todo.isDone).toList();
              ...
              incompleteTodos.sort((a, b) {
                switch (_sortOption) {
                  ...
                  case SortOption.priority:
                    int priorityA = a.priority?.index ?? -1;
                    int priorityB = b.priority?.index ?? -1;
                    return priorityB.compareTo(priorityA);
                  case SortOption.dueDate:
                    DateTime dateA = a.selectedDate ?? DateTime(2100);
                    DateTime dateB = b.selectedDate ?? DateTime(2100);
                    return dateA.compareTo(dateB);
                }
              });

              completeTodos.sort((a, b) {
                switch (_sortOption) {
                  case SortOption.createdTime:
                    return b.createdTime.compareTo(a.createdTime);
                  case SortOption.priority:
                ...
                children: [
                  Padding(
                    ...
                    child: TextButton.icon(
                      ...
                      label: Text('จัดเรียงตาม: ${_sortOption.displayName}'),
                    ),
                  ),
                  Expanded(
                    child: Builder(
